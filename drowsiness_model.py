...
# plot_model(model, to_file='model.png', show_shapes=True)s

#to add the input in model
history = model.fit(train_batch, validation_data=valid_batch,epochs=20,steps_per_epoch=SPE ,validation_steps=VS)
